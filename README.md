...
<!-- GitHub Stats -->
<p>
  <img src="https://github-readme-stats.vercel.app/api?username=speed3xz&show_icons=true&theme=radical" alt="GitHub Stats"/>
</p>
...
```
yarn add @speed3xz/meta
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:speed3xz/meta
```

Then import your code using:
```ts 
import makeWASocket from '@speed3xz/meta'
```
...
```ts
import makeWASocket, { useMultiFileAuthState } from '@speed3xz/meta'
...
```ts
import makeWASocket, { DisconnectReason, useMultiFileAuthState } from '@speed3xz/meta'
...
```ts
import makeWASocket, { useSingleFileAuthState, useMongoFileAuthState } from '@speed3xz/meta'
...
import { makeInMemoryStore, getAggregateVotesInPollMessage } from '@speed3xz/meta'
...
```ts
import makeWASocket, { makeInMemoryStore } from '@speed3xz/meta'
          ...
          { 
             ...
             buttonParamsJson: JSON.stringify({ 
                payment_settings: [{ 
                   ...
                   pix_static_code:  { 
                      merchant_name: 'speed3xzn kawaii >\\\\\\<', 
                      key: 'example@speed3xz.com', 
       ...
       interactiveButtons: [ 
          { 
             ...
             buttonParamsJson: JSON.stringify({ 
                ...
                additional_note: 'speed3xzn Kawaii >\\\<', 
...
await suki.sendMessage(
    ...
    { 
        album: [{
        	image: {
        		url: 'https://example.com/speed3xz.jpg'
        	}, 
        	caption: 'Hay'
        }, {
        	image: Buffer, 
        	...
        	video: {
        		url: 'https://example.com/speed3xz.mp4'
        	}, 
        	caption: 'Hay'
        }, {
        	video: Buffer, 
...
import { downloadMediaMessage, getContentType } from '@speed3xz/meta'
